...
final fetchTopicsMemoizer = AsyncMemoizer();

Future<List<Topic>> fetchTopics() async {
  return await fetchTopicsMemoizer.runOnce(Global.topicsRef.getData);
}
...
class TopicScreen extends StatelessWidget {
  final Topic topic;
  const TopicScreen({Key key, this.topic}) : super(key: key);
